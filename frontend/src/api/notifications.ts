...
export interface NotificationItem { id: string; title: string; body: string; type: string; status: 'UNREAD' | 'READ'; link: string | null; createdAt: string; readAt: string | null; sender?: string | null; announcementId?: string | null }
export const notificationsApi = {
  ...
  unread: async (id: string) => { await apiClient.post(`/notifications/${id}/unread`); window.dispatchEvent(new Event('notifications-read')); },
