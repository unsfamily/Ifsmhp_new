          ...
          <div className="max-w-3xl">
            ...
            >
              <span className="block overflow-hidden">
                <span className="about-heading-word about-shimmer-word">Learn,</span>{' '}
                <span className="about-heading-word">share,</span>{' '}
                <span className="about-heading-word about-shimmer-word">and</span>{' '}
                <span className="about-heading-word about-shimmer-word">connect</span>
              </span>
            </h1>
